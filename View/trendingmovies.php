...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <span class="title"> <i class="fa-solid fa-fire"></i> Trending Movies</span>
                </div>
            </div>
            <div class="row mt-4">
    ...
    <!-- Footer -->
    <section>
        <footer style="background-color: #0e0d0d; margin-top: 40px;" class="text-white pt-5 pb-4">
