      ...
      <main>
        <div class="container-fluid px-4">
          ...
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">MovieDetail</li>
          </ol>
          <div class="mt-3">
            <!-- For delete message -->
                ...
                <tbody>
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      echo "<tr onclick='location.href = \"show.php?id=" . $row["movieCode"] . "\"'>
                        <td>" . $row["movieCode"] . "</td>
                        <td>" . $row["movieName"] . "</td>
                        ...
                        <a href='delete.php?id=" . $row["movieCode"] . "'><i class='fas fa-trash'></i></a></center>
                      </td>
                      </tr>";
                    }
                  } else {
