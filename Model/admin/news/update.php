      ...
      <main>
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form onsubmit="return validateFile(event)" action="../../../Controller/cr_updatenews.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" required class="form-control" id="exampleInputPassword1" name="newsTitle" value="<?php echo $data["newsTitle"] ?> ">
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">newsDOR</label>
                  <div class="input-group date" id="datepicker">
                    <input type="text" required class="form-control" id="exampleInputPassword1" name="newsDOR" value="<?php echo $data['newsDOR']; ?> ">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" required class="form-control" id="exampleInputPassword1" name="newsWriter" value="<?php echo $data["newsWriter"] ?> ">
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">newsContent</label>
                  <textarea style="white-space: pre-wrap;" class="form-control" required name="newsContent" id="" cols="30" rows="10"><?php echo $data['newsContent'] ?></textarea>
                </div>
                <div class="mb-3">
